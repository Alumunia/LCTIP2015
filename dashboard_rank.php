...
?>
    ...
    <section id="portfolio">
        <div class="container">
                    ...
                    <h2 class="text-center" style="margin-top: -150px;margin-bottom: 30px;">Daftar Nilai 	<a type="button" href="dashboard_rank_print.php" class="btn btn-info pull-right">	<span class="glyphicon glyphicon-print" aria-hidden="true"></span></a>
         </h2>
     ...
     <table class="table table-bordered" style="width: 1250px;style=;margin-left: -70px;" >
              ...
              <tbody>
					<?php
$no=1;
$result = mysqli_query($con,"SELECT * FROM `registration` WHERE quiz_ticket=1 AND quiz_allowed=1;") 
or die(mysqli_error());  
...
?>
                <tr style="font-size:12px">
                  ...
                  <td><?php echo $row['start_quiz'];?></td>
                  <td><?php echo $row['end_quiz'];?></td>
...
<?php
 ...
 <a href ="score_process.php?exam=<?php echo $row['user'];?>" type="button" class="btn btn-warning btn-sm"  > PERIKSA</a>     
<?php
}		  
?>
			</td>
