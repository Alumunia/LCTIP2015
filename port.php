...
$wrong_choice_1 = mysqli_real_escape_string($con, htmlentities($_POST['wrong_choice_1']));
$wrong_choice_2 = mysqli_real_escape_string($con, htmlentities($_POST['wrong_choice_2']));
$wrong_choice_3 = mysqli_real_escape_string($con, htmlentities($_POST['wrong_choice_3']));
$wrong_choice_4 = mysqli_real_escape_string($con, htmlentities($_POST['wrong_choice_4']));
